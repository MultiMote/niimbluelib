...
export class Abstraction {
  ...
  public async waitUntilPrintFinishedByPageIndex(pagesToPrint: number, timeoutMs: number = 5_000): Promise<boolean> {
   ...
   * @param shouldCancel
   */
  public async waitUntilPrintFinishedByStatusPoll(
    pagesToPrint: number,
   ...
   * @param pollIntervalMs Poll interval in milliseconds.
   */
  public async waitUntilPrintFinishedByPrintEndPoll(
    pagesToPrint: number,
