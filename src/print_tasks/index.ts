...
import { B21L2BPrintTask } from "./B21L2BPrintTask";
...
export const modelPrintTasks: Partial<Record<PrintTaskName, (ModelWithProtocol | M)[]>> = {
  ...
  D110M_V4: [{ m: M.D110_M, v: 4 }, M.D11_H, M.B21_PRO, M.B1_PRO, M.C1, M.EP1C],
  H1S: [M.H1S],
};
...
export { B1PrintTask, B21V1PrintTask, D110PrintTask, OldD11PrintTask, D110MV4PrintTask, B21L2BPrintTask, H1SPrintTask };
